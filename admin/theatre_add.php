<?php
  ...
  if(!empty($_POST))
  {
    ...
    {
      $db = Database::connect();
      $statement = $db->prepare("INSERT INTO theatre (img_theatre, titre_theatre, annee_theatre, auteur_theatre, mise_scene_theatre, adaptation_theatre, resume_theatre) values(?,?,?,?,?,?,?)");
      $statement->execute(array($image, $titre, $annee, $auteur, $adaptation, $miseenscene, $resume));
      Database::disconnect();
...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    <div class="container admin">
           ...
           <h1>AJOUTER UNE PIECE DE THEATRE</h1>
           <br>
           <form class="form" role="form" action="theatre_add.php" method="post" enctype="multipart/form-data">
             ...
             <div class="form-actions">
               ...
               <a class="btn btn-primary" href="theatre_admin.php">Retour</a>
             </div>
           </form>

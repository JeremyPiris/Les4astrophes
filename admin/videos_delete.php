<?php
  ...
  if(!empty($_POST))
  {
    ...
    $db = Database::connect();
    $statement = $db->prepare("DELETE FROM videos WHERE id_videos = ?");
...
<html lang="fr" dir="ltr">
  ...
  <body>
    ...
    <div class="container admin">
           ...
           <br>
           <form class="form" role="form" action="videos_delete.php" method="post">
             <input type="hidden" name="id" value="<?php echo $id ?>">
             <p class="alert alert-warning">Etes-vous sûr de vouloir supprimer ?</p>
             <div class="form-actions">
               <button type="submit" class="btn btn-warning">Oui</button>
               <a class="btn btn-default" href="videos_admin.php">Non</a>
             </div>
           </form>

...
<html lang="fr" dir="ltr">
  ...
  <head>
    ...
    <meta charset="utf-8">
    <title>Lesquatreastrophes | Vidéos</title>
  ...
  <div class="container-fluid site">
    ...
    <nav class="navbar navbar-expand-sm justify-content-center site_navigation">
      ...
      <ul class="collapse navbar-collapse nav-fill" id="navbarSupportedContent">
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="videos.php">Vidéos</a>
          </li>
          <li class="nav-item">
    ...
    <div class="row justify-content-center videos_body">

      <?php
        require 'admin/database.php';
        $db = Database::connect();
        $statement = $db->query('SELECT * FROM videos ORDER BY videos.id_videos DESC');
        $videos = $statement->fetchAll();
        foreach ($videos as $film) {
          echo '
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
              <a href="videos_details.php?Id='.$film['id_videos'].'">
                <img src="images/films/'.$film['img_video'].'" alt="" class="img-thumbnail" />
                <p class="titre_film">'.$film['titre_video'].'</p>
              </a>
            </div>
            ';
          }
